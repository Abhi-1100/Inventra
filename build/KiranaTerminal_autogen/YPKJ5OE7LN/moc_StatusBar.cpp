...
static constexpr auto qt_meta_stringdata_ZN6Kirana9StatusBarE = QtMocHelpers::stringData(
    "Kirana::StatusBar",
    "runNowRequested",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN6Kirana9StatusBarE[] = {
...
Q_CONSTINIT const QMetaObject Kirana::StatusBar::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6Kirana9StatusBarE.offsetsAndSizes,
    qt_meta_data_ZN6Kirana9StatusBarE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6Kirana9StatusBarE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<StatusBar, std::true_type>,
        // method 'runNowRequested'
...
void Kirana::StatusBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (StatusBar::*)();
            if (_q_method_type _q_method = &StatusBar::runNowRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Kirana::StatusBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6Kirana9StatusBarE.stringdata0))
