...
static constexpr auto qt_meta_stringdata_ZN6Kirana14SettingsWidgetE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN6Kirana14SettingsWidgetE[] = {
...
Q_CONSTINIT const QMetaObject Kirana::SettingsWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6Kirana14SettingsWidgetE.offsetsAndSizes,
    qt_meta_data_ZN6Kirana14SettingsWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6Kirana14SettingsWidgetE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SettingsWidget, std::true_type>,
        // method 'settingsChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const Kirana::AppSettings &, std::false_type>,
        // method 'reRunRequested'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void Kirana::SettingsWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (SettingsWidget::*)(const Kirana::AppSettings & );
        ...
        {
            using _q_method_type = void (SettingsWidget::*)();
            if (_q_method_type _q_method = &SettingsWidget::reRunRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *Kirana::SettingsWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6Kirana14SettingsWidgetE.stringdata0))
